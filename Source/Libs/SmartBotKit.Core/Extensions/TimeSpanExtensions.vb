...
#Region " Public Extension Methods "
        ...
        Public Function IsHourInRange(sender As TimeSpan, start As TimeSpan, [end] As TimeSpan) As Boolean
        ...
        <Extension>
        <EditorBrowsable(EditorBrowsableState.Always)>
        Public Function IsInRange(sender As TimeSpan, start As TimeSpan, [end] As TimeSpan) As Boolean
