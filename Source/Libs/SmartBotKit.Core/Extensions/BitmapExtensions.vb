...
#Region " Public Extension Methods "
        ...
        Public Function ConvertToPixelFormat(sender As Bitmap, format As PixelFormat, Optional disposeSourceImage As Boolean = False) As Bitmap
        ...
        <Extension>
        <EditorBrowsable(EditorBrowsableState.Always)>
        Public Function Crop(sender As Bitmap,
...
rect As Rectangle) As Image
        ...
        <Extension>
        <EditorBrowsable(EditorBrowsableState.Always)>
        Public Function GetPixelInfo(sender As Bitmap) As IEnumerable(Of Imaging.PixelInfo)
        ...
        <Extension>
        <EditorBrowsable(EditorBrowsableState.Always)>
        Public Function Resize(sender As Bitmap, size As Size) As Bitmap
