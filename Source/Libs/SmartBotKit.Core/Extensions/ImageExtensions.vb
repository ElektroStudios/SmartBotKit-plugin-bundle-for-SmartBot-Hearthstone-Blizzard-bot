...
#Region " Public Extension Methods "
        ...
        Public Function ConvertToPixelFormat(sender As Image, format As PixelFormat, Optional disposeSourceImage As Boolean = False) As Image
        ...
        <Extension>
        <EditorBrowsable(EditorBrowsableState.Always)>
        Public Function Crop(sender As Image,
x As Integer, y As Integer,
width As Integer, height As Integer) As Image
...
rect As Rectangle) As Image
        ...
        <Extension>
        <EditorBrowsable(EditorBrowsableState.Always)>
        Public Iterator Function GetPixelInfo(sender As Image) As IEnumerable(Of Imaging.PixelInfo)
        ...
        <Extension>
        <EditorBrowsable(EditorBrowsableState.Always)>
        Public Function Resize(sender As Image, size As Size) As Image
