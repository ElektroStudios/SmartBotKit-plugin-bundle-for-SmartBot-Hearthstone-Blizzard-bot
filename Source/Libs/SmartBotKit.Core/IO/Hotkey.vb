...
#Region " Events "
        ...
        Public Custom Event Press As EventHandler(Of HotkeyPressEventArgs)
            ...
            <DebuggerNonUserCode>
            <DebuggerStepThrough>
            AddHandler(value As EventHandler(Of HotkeyPressEventArgs))
                Me.Events.AddHandler("PressEvent", value)
            End AddHandler

            <DebuggerNonUserCode>
            <DebuggerStepThrough>
            RemoveHandler(value As EventHandler(Of HotkeyPressEventArgs))
                Me.Events.RemoveHandler("PressEvent", value)
            End RemoveHandler

            <DebuggerNonUserCode>
            <DebuggerStepThrough>
            RaiseEvent(sender As Object, e As HotkeyPressEventArgs)
...
#Region " Constructors "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Sub New(modifier As HotkeyModifiers,
key As Keys)
...
#Region " Event Invocators "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Protected Overridable Sub OnHotkeyPress(e As HotkeyPressEventArgs)
