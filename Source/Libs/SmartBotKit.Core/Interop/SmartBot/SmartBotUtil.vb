...
#Region " Public Methods "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Function GetAutomationElement(automationId As String) As AutomationElement
        ...
        ''' </returns>
        ''' ----------------------------------------------------------------------------------------------------
        Public Shared Function FindPluginByName(name As String, Optional stringComparison As StringComparison = StringComparison.Ordinal) As Plugin
...
#Region " Private Methods "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Private Shared Function GetAutomationElement(process As Process, automationId As String) As AutomationElement
        ...
        Private Shared Function GetWindowPlacement(hWnd As IntPtr) As WindowPlacement
        ...
        Private Shared Function SetWindowPlacement(hWnd As IntPtr, wpl As WindowPlacement) As Boolean
            Return NativeMethods.SetWindowPlacement(hWnd, wpl)
        End Function

        Private Shared Function GetWindowSize(hWnd As IntPtr) As Size
            Dim rc As Rectangle
            NativeMethods.GetWindowRect(hWnd, rc)
            Return rc.Size
        End Function

        Private Shared Function SetWindowSize(hWnd As IntPtr, sz As Size) As Boolean
            Dim rc As Rectangle
            NativeMethods.GetWindowRect(hWnd, rc)
        ...
        Private Shared Function GetWindowPosition(hWnd As IntPtr) As Point
            Dim rc As Rectangle
            NativeMethods.GetWindowRect(hWnd, rc)
            Return rc.Location
        End Function

        Private Shared Function SetWindowPosition(hWnd As IntPtr, pt As Point) As Boolean
            Dim rc As Rectangle
            NativeMethods.GetWindowRect(hWnd, rc)
            Return NativeMethods.SetWindowPos(hWnd, IntPtr.Zero,
                                              pt.X, pt.Y,
