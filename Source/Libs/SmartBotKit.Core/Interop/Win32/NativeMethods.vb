...
#Region " P/Invoke declarations "
        ...
        <DllImport("GDI32.dll")>
        Public Shared Function BitBlt(hdc As IntPtr,
nXDest As Integer,
nYDest As Integer,
nWidth As Integer,
nHeight As Integer,
...
dwRop As TernaryRasterOperations
        ...
        Public Shared Function BringWindowToTop(hwnd As IntPtr
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("GDI32.dll")>
        Public Shared Function CreateCompatibleBitmap(hdc As IntPtr,
width As Integer,
height As Integer
        ) As IntPtr
        End Function
        ...
        Public Shared Function CreateCompatibleDC(hdc As IntPtr
        ) As IntPtr
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("GDI32.dll")>
        Public Shared Function DeleteDC(hdc As IntPtr
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        Public Shared Function DwmGetWindowAttribute(hwnd As IntPtr,
...
attributeSize As UInteger
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function GetWindowDC(hwnd As IntPtr
        ) As IntPtr
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function GetWindowPlacement(hwnd As IntPtr,
        ...
        Public Shared Function GetWindowText(hwnd As IntPtr,
...
cch As Integer
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function IsIconic(hwnd As IntPtr
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function IsWindow(hwnd As IntPtr
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function IsWindowVisible(hwnd As IntPtr
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function RegisterHotKey(hwnd As IntPtr,
id As Integer,
...
vk As UInteger
        ...
        Public Shared Function ReleaseDC(hwnd As IntPtr,
hdc As IntPtr
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
...
hObject As IntPtr
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function SetForegroundWindow(hwnd As IntPtr
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function SetWindowPlacement(hwnd As IntPtr,
                                                  ByRef refWindowPlacement As WindowPlacement
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
...
uFlags As SetWindowPosFlags
        ...
        Public Shared Function SetWindowText(hwnd As IntPtr,
text As String
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ''' ----------------------------------------------------------------------------------------------------
        ...
        Public Shared Function ShowWindow(hwnd As IntPtr,
            <MarshalAs(UnmanagedType.I4)> windowState As NativeWindowState
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ''' ----------------------------------------------------------------------------------------------------
        ''' <summary>
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function UnregisterHotKey(hwnd As IntPtr,
id As Integer
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
...
maxCount As Integer
        ...
        Public Shared Function GetWindowLong(hwnd As IntPtr,
               <MarshalAs(UnmanagedType.I4)> flags As WindowLongFlags
        ) As UInteger
        End Function
        ...
        Public Shared Function GetWindowLongPtr(hwnd As IntPtr,
                  <MarshalAs(UnmanagedType.I4)> flags As WindowLongFlags
        ) As IntPtr
        End Function
...
newLong As UInteger
        ...
        Public Shared Function SetWindowLongPtr(hwnd As IntPtr,
                  <MarshalAs(UnmanagedType.I4)> flags As WindowLongFlags,
newLong As IntPtr
        ) As IntPtr
        End Function
