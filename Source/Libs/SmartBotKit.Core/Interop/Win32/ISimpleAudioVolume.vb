...
Namespace SmartBotKit.Interop.Win32
    ...
    Public Interface ISimpleAudioVolume
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <PreserveSig>
        Function SetMasterVolume(<[In]> <MarshalAs(UnmanagedType.R4)> levelNormalization As Single,
                                 <[In]> <MarshalAs(UnmanagedType.LPStruct)> eventContext As Guid) As HResult
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <PreserveSig>
        Function SetMute(<[In]> <MarshalAs(UnmanagedType.Bool)> isMuted As Boolean,
                         <[In]> <MarshalAs(UnmanagedType.LPStruct)> eventContext As Guid) As HResult
