...
#Region " Cosntructors "
        ...
        ''' </param>
        ''' ----------------------------------------------------------------------------------------------------
        Public Sub New(aspectRatio As Point, resolution As Size, captureRectangle As Rectangle)
...
#Region " Public Methods "
        ...
        ''' </returns>
        ''' ----------------------------------------------------------------------------------------------------
        Public Function Scale(newResolution As Size) As ImageCaptureInfo
        ...
        Public Overrides Function ToString() As String
            ...
            sb.AppendLine($"{NameOf(Me.AspectRatio)}={Me.AspectRatio}; ")
            sb.AppendLine($"{NameOf(Me.Resolution)}={Me.Resolution}; ")
            sb.AppendLine($"{NameOf(Me.CaptureRectangle)}={Me.CaptureRectangle}")
