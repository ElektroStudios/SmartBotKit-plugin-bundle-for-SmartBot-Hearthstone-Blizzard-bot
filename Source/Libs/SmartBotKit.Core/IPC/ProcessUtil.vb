...
#Region " Public Methods "
        ...
        Public Shared Sub SetProcessPrivileges(handle As IntPtr,
            ...
            privileges.ForEachFlag(
                Sub(priv As ProcessPrivileges)
                    ProcessUtil.SetProcessPrivilege(Environment.MachineName, handle, $"Se{priv}", privilegeState)
                End Sub)
        ...
        Public Shared Sub SetProcessPrivileges(computer As String,
            ...
            Else
                privileges.ForEachFlag(
                Sub(priv As ProcessPrivileges)
                    ProcessUtil.SetProcessPrivilege(computer, handle, $"Se{priv}", privilegeState)
                End Sub)
        ...
        Public Shared Function GetProcessPrivilegeState(handle As IntPtr,
            ...
            Return ProcessUtil.GetProcessPrivilegeState(Environment.MachineName, handle, $"Se{privilege}")
        ...
        Public Shared Function GetProcessPrivilegeState(computer As String,
            ...
            Else
                Return ProcessUtil.GetProcessPrivilegeState(computer, handle, $"Se{privilege}")
        ...
        Public Shared Function GetProcessPrivilegeState(computer As String,
            ...
            Else
                ...
                Else
                    Return ProcessUtil.GetProcessPrivilegeState(computer, proc.Handle, $"Se{privilege}")
