...
#Region " Public Methods "
        ...
        ''' </param>
        ''' ----------------------------------------------------------------------------------------------------
        Public Shared Sub SetMuteApplication(pr As Process, mute As Boolean)
        ...
        ''' </returns>
        ''' ----------------------------------------------------------------------------------------------------
        Public Shared Function IsApplicationMuted(pr As Process) As Boolean
            Dim volume As ISimpleAudioVolume = AudioUtil.GetVolumeObject(pr)
            If (volume IsNot Nothing) Then
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Function GetPApplicationVolume(pr As Process) As Integer
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Sub SetApplicationVolume(pr As Process, volumeLevel As Integer)
...
#Region " Private Methods "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepperBoundary>
        Private Shared Function GetVolumeObject(pr As Process) As ISimpleAudioVolume
