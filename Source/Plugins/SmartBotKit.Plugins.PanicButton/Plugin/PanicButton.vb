...
#Region " Constructors "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Sub New(dataContainer As PanicButtonPluginData)
            ...
            Bot.Log(
                $"[Panic Button] Plugin initialized. Active hotkey is: {{ {dataContainer.ModifierA} + { _
                       dataContainer.ModifierB} + {dataContainer.Key} }} ")
        End Sub
...
#Region " Event Handlers "
        ...
        ''' </param>
        ''' ----------------------------------------------------------------------------------------------------
        Private Sub PanicButton_Press(sender As Object, e As HotkeyPressEventArgs) Handles Me.Press
