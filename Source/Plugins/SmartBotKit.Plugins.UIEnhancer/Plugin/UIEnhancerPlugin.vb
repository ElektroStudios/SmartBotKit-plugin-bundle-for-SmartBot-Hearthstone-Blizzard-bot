...
#Region " Public Methods "
                ...
                If (Me.DataContainer.EnableWindowPositionRestorator) Then
                    ...
                    Select Case Me.DataContainer.WindowState
                        Case NativeWindowState.Maximize, NativeWindowState.ShowMaximized
                            Bot.Log($"[UI Enhancer] -> SmartBot window state restored to: {Me.DataContainer.WindowState}")

                        Case Else
                            Bot.Log(
                            $"[UI Enhancer] -> SmartBot window state restored to: {Me.DataContainer.WindowState} | { _
                                   Me.DataContainer.CurrentPosition} | { _
                                   Me.DataContainer.NormalSize}")
        ...
        ''' ----------------------------------------------------------------------------------------------------
        ''' <summary>
        ''' Releases all the resources used by this <see cref="UIEnhancerPlugin"/> instance.
        ''' </summary>
        ''' ----------------------------------------------------------------------------------------------------
...
#Region " Private Methods "
        ...
        ''' </param>
        ''' ----------------------------------------------------------------------------------------------------
        Private Sub SetWindowInfo(mode As Bot.Mode, heroClass As Card.CClass, enemyClass As Card.CClass)
