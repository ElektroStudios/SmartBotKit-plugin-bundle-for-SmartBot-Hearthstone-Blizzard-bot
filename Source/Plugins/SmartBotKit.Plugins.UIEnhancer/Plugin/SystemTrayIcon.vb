...
#Region " Constructors "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Sub New(ownerPlugin As UIEnhancerPlugin)
...
#Region " Event Handlers "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Private Sub MenuItemShowHS_Click(sender As Object, e As EventArgs) Handles MenuItemShowHS.Click
            ...
            Bot.Log($"[UI Enhancer] -> Hearthstone window state changed to: {newWindowState}")
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Private Sub MenuItemHideHS_Click(sender As Object, e As EventArgs) Handles MenuItemHideHS.Click
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Private Sub MenuItemCloseHS_Click(sender As Object, e As EventArgs) Handles MenuItemCloseHS.Click
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Private Sub MenuItemShowS_Click(sender As Object, e As EventArgs) Handles MenuItemShowSB.Click
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Private Sub MenuItemHideS_Click(sender As Object, e As EventArgs) Handles MenuItemHideSB.Click
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Private Sub MenuItemCloseS_Click(sender As Object, e As EventArgs) Handles MenuItemCloseSB.Click
