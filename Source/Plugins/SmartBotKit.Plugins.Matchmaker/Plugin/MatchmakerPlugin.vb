...
#Region " Public Methods "
        ...
        Public Overrides Sub OnHandleMulligan(choices As List(Of Card.Cards), opponentClass As Card.CClass, ownClass As Card.CClass)
            ...
            If Not allowedClasses.Contains(opponentClass) Then
                Bot.Concede()
                Bot.Log($"[Matchmaker] -> Game conceded to '{opponentClass}' opponent.")
            ...
            Else
                If (Me.DataContainer.PlaySoundFile) Then
                    ...
                    If Not file.Exists() Then
                        Bot.Log($"[Matchmaker] -> Sound file not found: '{file.FullName}'")
                    Else
                ...
                Bot.Log($"[Matchmaker] -> Match found with '{opponentClass}' opponent!")
                Bot.StopBot()
        ...
        Public Overrides Sub OnStarted()
            ...
            Bot.Log($"[Matchmaker] -> Using mode: '{Bot.CurrentMode}'")
        ...
        ''' ----------------------------------------------------------------------------------------------------
        ''' <summary>
        ''' Releases all the resources used by this <see cref="MatchmakerPlugin"/> instance.
        ''' </summary>
        ''' ----------------------------------------------------------------------------------------------------
...
#Region " Private Methods "
        ...
        Private Function GetAllowedClasses() As ReadOnlyCollection(Of Card.CClass)
            ...
            If Me.DataContainer.AllowDeathKnight Then
                l.Add(Card.CClass.DEATHKNIGHT)
            End If
