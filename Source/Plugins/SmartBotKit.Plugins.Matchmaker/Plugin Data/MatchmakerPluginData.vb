...
#Region " Settings "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        ''' <summary>
        ''' Gets or sets the bot mode for matchmaking.
        ''' </summary>
        ''' ----------------------------------------------------------------------------------------------------
        <Category("Settings")>
        ...
        ''' ----------------------------------------------------------------------------------------------------
        ''' <summary>
        ''' Gets or sets a value indicating whether to allow matchmaking with DeathKnight class.
        ''' </summary>
        ''' ----------------------------------------------------------------------------------------------------
        <Category("Settings: Allowed Matches")>
        <DisplayName("DeathKnight")>
        <Browsable(True)>
        Public Property AllowDeathKnight As Boolean
...
#Region " Constructors "
        ...
        Public Sub New()
            ...
            Me.Mode = Bot.Mode.Casual
            Me.Deck = "None"

            Me.ActivateWindow = True
            Me.PlaySoundFile = True

            Me.AllowDeathKnight = True
