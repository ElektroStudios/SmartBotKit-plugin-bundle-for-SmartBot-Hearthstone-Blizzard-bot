        ...
        Public Overrides Sub OnGameBegin()
            If (Me.DataContainer.Enabled) Then
                ...
                Select Case Bot.CurrentMode
                    Case Mode.Standard
                        If Not Me.DataContainer.CrawlStandardGames Then
                            Exit Sub
                        End If

                    Case Mode.Wild
                        If Not Me.DataContainer.CrawlWildGames Then
                            Exit Sub
                        End If

                    Case Mode.Twist
                        If Not Me.DataContainer.CrawlTwistGames Then
                            Exit Sub
                        End If

                    Case Mode.Casual
                        If Not Me.DataContainer.CrawlCasualGames Then
                            Exit Sub
                        End If

                    Case Mode.DuelsNormal
                        If Not Me.DataContainer.CrawlDuelsGames Then
                            Exit Sub
                        End If
                ...
                If (hour >= Me.DataContainer.HourStart) AndAlso (hour < Me.DataContainer.HourEnd) Then
                    ...
                    If (dirInfo.Exists) Then
                        ...
                        Dim newLine As String =
                                $"{Date.Now:yyyy-MM-dd HH\:mm\:ss},{Bot.CurrentMode},{standardRank},{ _
                                wildrank},{battletag}"
