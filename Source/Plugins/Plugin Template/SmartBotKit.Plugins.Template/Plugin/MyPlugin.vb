...
#Region " Public Methods "
        ...
        ''' </param>
        ''' ----------------------------------------------------------------------------------------------------
        Public Overrides Sub OnHandleMulligan(choices As List(Of Card.Cards), opponentClass As Card.CClass, ownClass As Card.CClass)
            Me.LogMethodName()
        ...
        ''' </param>
        ''' ----------------------------------------------------------------------------------------------------
        Public Overrides Sub OnWhisperReceived([friend] As [Friend], message As String)
            Me.LogMethodName()
        ...
        ''' </param>
        ''' ----------------------------------------------------------------------------------------------------
        Public Overrides Sub OnFriendRequestReceived(request As FriendRequest)
            Me.LogMethodName()
        ...
        ''' </param>
        ''' ----------------------------------------------------------------------------------------------------
        Public Overrides Sub OnFriendRequestAccepted([friend] As [Friend])
            Me.LogMethodName()
        ...
        ''' </param>
        ''' ----------------------------------------------------------------------------------------------------
        Public Overrides Sub OnGameResolutionUpdate(width As Integer, height As Integer)
            Me.LogMethodName()
...
#Region " Private Methods "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Private Sub LogMethodName(<CallerMemberName> Optional methodName As String = "")
        ...
        Private Function TestFunction(value As Boolean) As Boolean
            Return value
        End Function
