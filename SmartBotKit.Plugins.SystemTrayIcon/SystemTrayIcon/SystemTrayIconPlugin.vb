...
Namespace SystemTrayIcon
    ...
    ''' ----------------------------------------------------------------------------------------------------
    ''' <summary>
    ''' This plugin creates a <see cref="NotifyIcon"/> on runtime to add some basic features to SmartBot,
    ''' such as the ability to minimize to system-tray, restore from system-tray, and close/kill SmartBot program.
    ''' </summary>
    ''' ----------------------------------------------------------------------------------------------------
    ''' <seealso cref="Plugin"/>
    ''' ----------------------------------------------------------------------------------------------------
...
#Region " Private Fields "
        ...
        Private ReadOnly iconMethodDelegate As New ParameterizedThreadStart(
            Sub()
                Me.Icon = New SystemTrayIcon(Me.DataContainer)
