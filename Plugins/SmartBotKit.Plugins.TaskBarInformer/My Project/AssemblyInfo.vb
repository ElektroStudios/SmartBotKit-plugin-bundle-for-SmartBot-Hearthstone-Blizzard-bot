...
<Assembly: AssemblyTitle("Taskbar Informer")>
<Assembly: AssemblyDescription("Prints statistical info. on the taskbar icon and also displays a progress bar for Arena mode.")>
